...
const g = (file: string) => `${APP}/uploads/seed/grains/${file}`;
const IMG = {
  rajma: g("rajma.jpg"),
  chana: g("chana.jpg"),
  moong: g("moong.jpg"),
  ...
  toor: g("toor.jpg"),
  // Subtype covers
  rajmaChitra: g("rajma-chitra.jpg"),
  rajmaLal: g("rajma-lal.jpg"),
  rajmaCranberry: g("rajma-cranberry.jpg"),
  rajmaChina: g("rajma-china.jpg"),
  rajmaButton: g("rajma-button.jpg"),
  rajmaPink: g("rajma-pink.jpg"),
  rajmaSrinagar: g("rajma-srinagar.jpg"),
  kabliGarbanzo: g("kabli-garbanzo.jpg"),
  kabliBalay: g("kabli-balay.jpg"),
  kabliMexico: g("kabli-mexico.jpg"),
  kabliRussian: g("kabli-russian.jpg"),
  chanaWhole: g("chana-whole.jpg"),
  chanaDal: g("chana-dal.jpg"),
  chanaBesan: g("chana-besan.jpg"),
  chanaKala: g("chana-kala.jpg"),
  chanaKabuli: g("chana-kabuli.jpg"),
  matarSafed: g("matar-safed.jpg"),
  matarHari: g("matar-hari.jpg"),
  matarBesan: g("matar-besan.jpg"),
  uradWhole: g("urad-whole.jpg"),
  uradDhuli: g("urad-dhuli.jpg"),
  uradChilka: g("urad-chilka.jpg"),
  uradDhowa: g("urad-dhowa.jpg"),
  moongWhole: g("moong-whole.jpg"),
  moongDhuli: g("moong-dhuli.jpg"),
  moongChilka: g("moong-chilka.jpg"),
  moongTalai: g("moong-talai.jpg"),
  moongDhowa: g("moong-dhowa.jpg"),
  masoorWhole: g("masoor-whole.jpg"),
  masoorMalka: g("masoor-malka.jpg"),
  masoorDal: g("masoor-dal.jpg"),
  lobiyaSafed: g("lobiya-safed.jpg"),
  lobiyaLal: g("lobiya-lal.jpg"),
  lobiyaBlackEye: g("lobiya-black-eye.jpg"),
  toorDal: g("toor-dal.jpg"),
  toorTukdi: g("toor-tukdi.jpg"),
  besanFine: g("besan-fine.jpg"),
...
const CATEGORIES: Array<{ name: string; tagline: string; icon: string; subs: Array<{ name: string; icon: string }> }> = [
  {
    ...
    icon: IMG.rajma,
    subs: [
      { name: "Chitra", icon: IMG.rajmaChitra },
      { name: "Rajma Lal", icon: IMG.rajmaLal },
      { name: "Cranberry", icon: IMG.rajmaCranberry },
      { name: "China", icon: IMG.rajmaChina },
      { name: "Button", icon: IMG.rajmaButton },
      { name: "Pink", icon: IMG.rajmaPink },
      { name: "Srinagar", icon: IMG.rajmaSrinagar },
    ],
  },
  {
    name: "Kabli",
    ...
    icon: IMG.kabli,
    subs: [
      { name: "Garbanzo", icon: IMG.kabliGarbanzo },
      { name: "Balay Balay", icon: IMG.kabliBalay },
      { name: "Mexico", icon: IMG.kabliMexico },
      { name: "Russian", icon: IMG.kabliRussian },
    ],
  },
  {
    name: "Chana",
    ...
    icon: IMG.chana,
    subs: [
      { name: "Whole", icon: IMG.chanaWhole },
      { name: "Dal", icon: IMG.chanaDal },
      { name: "Besan", icon: IMG.chanaBesan },
      { name: "Kala", icon: IMG.chanaKala },
      { name: "Kabuli", icon: IMG.chanaKabuli },
    ],
  },
  {
    name: "Matar",
    ...
    icon: IMG.matar,
    subs: [
      { name: "Safed", icon: IMG.matarSafed },
      { name: "Hari", icon: IMG.matarHari },
      { name: "Besan", icon: IMG.matarBesan },
    ],
  },
  {
    name: "Urad",
    ...
    icon: IMG.urad,
    subs: [
      { name: "Whole", icon: IMG.uradWhole },
      { name: "Dhuli", icon: IMG.uradDhuli },
      { name: "Chilka", icon: IMG.uradChilka },
      { name: "Dhowa", icon: IMG.uradDhowa },
    ],
  },
  {
    name: "Moong",
    ...
    icon: IMG.moong,
    subs: [
      { name: "Whole", icon: IMG.moongWhole },
      { name: "Dhuli", icon: IMG.moongDhuli },
      { name: "Chilka", icon: IMG.moongChilka },
      { name: "Talai", icon: IMG.moongTalai },
      { name: "Dhowa", icon: IMG.moongDhowa },
    ],
  },
  {
    name: "Masoor",
    ...
    icon: IMG.masoor,
    subs: [
      { name: "Whole", icon: IMG.masoorWhole },
      { name: "Malka", icon: IMG.masoorMalka },
      { name: "Dal", icon: IMG.masoorDal },
    ],
  },
  {
    name: "Lobiya",
    ...
    icon: IMG.lobiya,
    subs: [
      { name: "Safed", icon: IMG.lobiyaSafed },
      { name: "Lal", icon: IMG.lobiyaLal },
      { name: "Black Eye", icon: IMG.lobiyaBlackEye },
    ],
  },
  {
    name: "Toor",
    ...
    icon: IMG.toor,
    subs: [
      { name: "Dal", icon: IMG.toorDal },
      { name: "Tukdi", icon: IMG.toorTukdi },
    ],
  },
];
